...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        map.on('click', function(evt) {
            ...
            if (feature) {
                ...
                var info = "<h1>"+props["regio"]+"</h1><br />";
                    ...
                    info += "<p><em>Donacions de sang en aquesta regió per cada 1000 hab. (2013)</em>: " + props["donacionsRate2013"].toLocaleString() + "</p>";
                    info += "<p><em>Donacions de sang totals en aquesta regió (2013)</em>: " + props["donacions2013"].toLocaleString() + "</p>";
            }
        ...
        bar.append("text").text(function(d,i){ return d.properties.donacionsRate2013.toLocaleString()}).attr("y", barHeight / 2).attr("dy", ".35em").attr("x", function(d) { return x(d.properties.donacionsRate2013) - 3; }).attr("class","white");
